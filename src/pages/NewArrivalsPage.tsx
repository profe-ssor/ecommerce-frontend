...
export function NewArrivalsPage() {
  ...
  const filteredProducts = useProductFiltering(state.products, state.filters, state.sortBy);
  ...
  return (
    <main className="container mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">Discover the latest trends and must-have pieces</p>
      </div>
