...
export function AfricanWare() {
  ...
  return (
    <main className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">African Wear</h1>
        <p className="text-gray-600">Adorable and vibrant African wear perfect for every occasion.</p>
      </div>
